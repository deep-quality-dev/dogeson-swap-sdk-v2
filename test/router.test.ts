...
import { ChainId, CurrencyAmount, ETHER, Pair, Percent, Route, Router, Token, TokenAmount, Trade, WETH, RouterType } from '../src'
...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(RouterType.sphynx, new TokenAmount(WETH[ChainId.MAINNET], '1000'), new TokenAmount(token0, '1000'))
